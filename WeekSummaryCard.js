...
function WeekSummaryCard({ week, progress, totalTime, t }) {
  return (
    <div className="bg-gradient-to-r from-blue-100 via-green-100 to-purple-100 dark:from-blue-900 dark:via-green-900 dark:to-purple-900 rounded-xl shadow flex flex-col md:flex-row items-center justify-between p-4 mb-4 border border-blue-200 dark:border-blue-800 animate-fade-in">
      <div className="flex-1 flex flex-col gap-1">
        <div className="flex items-center gap-2">
          <span className="text-lg font-bold text-blue-700 dark:text-blue-300">{t.weekTitle} {week.week}</span>
          <span className="text-xs bg-blue-200 text-blue-800 dark:bg-blue-800 dark:text-blue-200 px-2 py-0.5 rounded">{week.title[t.lang]}</span>
        </div>
