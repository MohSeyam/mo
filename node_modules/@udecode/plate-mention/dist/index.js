...
var BaseMentionInputPlugin = (0, import_plate.createSlatePlugin)({
  key: "mention_input",
  node: { isElement: true, isInline: true, isVoid: true }
});
var BaseMentionPlugin = (0, import_plate.createTSlatePlugin)({
  key: "mention",
...
var getMentionOnSelectItem = ({
  ...
  const { getOptions, tf } = (0, import_plate2.getEditorPlugin)(editor, {
    key
  });
