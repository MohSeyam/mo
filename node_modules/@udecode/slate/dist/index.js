...
var insertNodes = (editor, nodes2, { nextBlock, removeEmpty, ...options } = {}) => {
  ...
  editor.tf.withoutNormalizing(() => {
    ...
    (0, import_slate61.insertNodes)(editor, nodes2, options);
  });
};
...
var insertText = (editor, text, { marks: marks2 = true, ...options } = {}) => {
  ...
  if (at) {
    import_slate62.Transforms.insertText(editor, text, { ...options, at });
    return;
  }
  if (editor.selection) {
    if (marks2 && editor.marks) {
      ...
      import_slate62.Transforms.insertText(editor, text, options);
    }
  }
};
...
var liftNodes = (editor, options) => {
  return (0, import_slate63.liftNodes)(editor, getQueryOptions(editor, options));
};
  ...
  if (children) {
    ...
    for (let i = node2.children.length - 1; i >= fromIndex; i--) {
      ...
      if (!options.match || childNode && options.match(childNode, childPath)) {
        (0, import_slate64.moveNodes)(editor, {
          ...options,
          at: childPath
        });
        moved = true;
...
var removeNodes = (editor, { children, previousEmptyBlock, ...opt } = {}) => {
  ...
  editor.tf.withoutNormalizing(() => {
    ...
    return (0, import_slate66.removeNodes)(editor, getQueryOptions(editor, options));
  });
};
...
var setNodes = (editor, props, { marks: marks2, ...options } = {}) => {
  if (marks2) {
    ...
    if (isExpandedRange || markAcceptingVoidSelected) {
      return (0, import_slate67.setNodes)(
        editor,
        props,
...
var unwrapNodes = (editor, options) => {
  (0, import_slate72.unwrapNodes)(editor, getQueryOptions(editor, options));
};
...
var wrapNodes = (editor, element, { children, ...opt } = {}) => {
  ...
  if (children) {
    ...
    editor.tf.withoutNormalizing(() => {
      ...
      (0, import_slate73.wrapNodes)(editor, element, {
        ...options,
        at: firstChildPath
      });
  ...
  (0, import_slate73.wrapNodes)(editor, element, options);
};
...
var createEditor = ({
  ...
  const editor = (0, import_slate74.createEditor)();
  if (children) {
  ...
  Object.assign(editor, {
    apply: (0, import_utils33.bindFirst)(import_slate74.apply, editor),
  ...
  Object.assign(editor, {
    ...
    getDirtyPaths: (0, import_utils33.bindFirst)(import_slate74.getDirtyPaths, editor),
    ...
    normalizeNode: (0, import_utils33.bindFirst)(import_slate74.normalizeNode, editor),
    removeMark: (0, import_utils33.bindFirst)(removeEditorMark, editor),
    shouldNormalize: (0, import_utils33.bindFirst)(import_slate74.shouldNormalize, editor)
  });
  Object.assign(editor, {
    ...
    hasPath: (0, import_utils33.bindFirst)(import_slate74.hasPath, editor),
    ...
    setNormalizing: (0, import_utils33.bindFirst)(import_slate74.setNormalizing, editor),
