...
function DayTemplate({ day, progress, totalTime, notesCount, journalCount, resourcesCount, tags, completedTasks, allTasks, sectionStats, rating, pomodoro }) {
  ...
  // رسم بياني دائري لتوزيع وقت البومودورو على المهام المنجزة في اليوم
    ...
    if (filteredPomodoro.length > 0) {
      ...
      pomodoroPieOptions = {
        ...
        plugins: {
          ...
          title: { display: true, text: i18n.language==='ar'?'توزيع وقت بومودورو على مهام اليوم':'Pomodoro Time Distribution (Today)', font: { size: 16 } },
          tooltip: {
            callbacks: {
  ...
  return (
    ...
    <div ref={templateRef} className="max-w-3xl mx-auto bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-blue-200 dark:border-blue-800 p-6 print:p-2 animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-blue-100 via-green-100 to-purple-100 dark:from-blue-900 dark:via-green-900 dark:to-purple-900 rounded-xl shadow p-4 mb-6 border border-blue-200 dark:border-blue-800">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="text-lg font-bold text-blue-700 dark:text-blue-300 mb-1">{day.day[i18n.language]}</div>

            <div className="text-xs bg-blue-200 text-blue-800 dark:bg-blue-800 dark:text-blue-200 px-2 py-0.5 rounded inline-block mb-2">{day.topic[i18n.language]}</div>
            ...
            <div className="flex gap-4 mt-2 flex-wrap">
              ...
              <span className="inline-flex items-center gap-1 text-blue-700 dark:text-blue-300 font-semibold"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" strokeWidth="2" /></svg>{resourcesCount} {t('resources')}</span>
